        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="sm:col-span-1 lg:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/matches" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Matches
                </Link>
              </li>
              <li>
          ...
          <div className="sm:col-span-1 lg:col-span-1">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/faqs" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  FAQs
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Terms &amp; Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="text-slate-300 hover:text-blue-400 transition-colors duration-200 text-sm">
                  Privacy Policy
                </Link>
              </li>
            </ul>
